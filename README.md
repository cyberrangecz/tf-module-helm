...
| [random_string.django_secret_key_mitre](https://registry.terraform.io/providers/hashicorp/random/latest/docs/resources/string) | resource |
...
| <a name="input_head_version"></a> [head\_version](#input\_head\_version) | Version of head helm package | `string` | `"3.1.0"` | no |
...
| <a name="input_netbird_client_management_url"></a> [netbird\_client\_management\_url](#input\_netbird\_client\_management\_url) | Public URL of the NetBird management server baked into sandbox VMs. Empty disables the sandbox NetBird integration. | `string` | `""` | no |
...
| <a name="input_openstack_config"></a> [openstack\_config](#input\_openstack\_config) | OpenStack configuration (mutually exclusive with aws\_config parameter) | <pre>object({<br/>    authUrl                     = string<br/>    applicationCredentialId     = string<br/>    applicationCredentialSecret = string<br/>    consoleType                 = optional(string, "spice-html5")<br/>    hypervisorCidr              = optional(string, "10.99.0.0/16")<br/>    mirrorType                  = optional(string, "erspanv1")<br/>    }<br/>  )</pre> | <pre>{<br/>  "applicationCredentialId": "",<br/>  "applicationCredentialSecret": "",<br/>  "authUrl": ""<br/>}</pre> | no |
